...
describe('Category e2e test', () => {
  ...
  it('should load create Category page', async () => {
    ...
    expect(await categoryUpdatePage.getPageTitle().getAttribute('id')).to.match(/emenuApp.category.home.createOrEditLabel/);
  });
  ...
  it('should create and save Categories', async () => {
    ...
    await categoryUpdatePage.menuSelectLastOption();
  ...
  it('should delete last Category', async () => {
    ...
    expect(await categoryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/emenuApp.category.delete.question/);
