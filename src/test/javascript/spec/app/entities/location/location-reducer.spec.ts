...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.FETCH_LOCATION_LIST actions', async () => {
      ...
      await store.dispatch(getLocationEntities()).then(() => expect(store.getActions()).toEqual(expectedActions));
    });
    ...
    it('dispatches ACTION_TYPES.FETCH_LOCATION actions', async () => {
      ...
      await store.dispatch(getLocationEntity(42666)).then(() => expect(store.getActions()).toEqual(expectedActions));
    });
