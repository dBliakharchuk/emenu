...
public class MenuResourceIntTest {
    ...
    private static final Integer DEFAULT_ID_MENU = 1;
    private static final Integer UPDATED_ID_MENU = 2;
    ...
    public void getAllMenus() throws Exception {
        ...
        restMenuMockMvc.perform(get("/api/menus?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].idMenu").value(hasItem(DEFAULT_ID_MENU)))
    ...
    public void getMenu() throws Exception {
        ...
        restMenuMockMvc.perform(get("/api/menus/{id}", menu.getId()))
            ...
            .andExpect(jsonPath("$.idMenu").value(DEFAULT_ID_MENU))
