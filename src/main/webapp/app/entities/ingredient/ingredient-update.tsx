...
import { getIngredientById, updateEntity, createEntity, reset } from './ingredient.reducer';
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="emenuApp.ingredient.home.createOrEditLabel">
              <Translate contentKey="emenuApp.ingredient.home.createOrEditLabel">Create or edit a Ingredient</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : ingredientEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="nameLabel" for="name">
                    <Translate contentKey="emenuApp.ingredient.name">Name</Translate>
                  </Label>
                  <AvField
                    id="ingredient-name"
                    type="text"
                ...
                <AvGroup>
                  <Label id="isAllergicLabel" check>
                    <AvInput id="ingredient-isAllergic" type="checkbox" className="form-control" name="isAllergic" />
                    <Translate contentKey="emenuApp.ingredient.isAllergic">Is Allergic</Translate>
                  </Label>
                </AvGroup>
