...
import { getMenuEntities as getMenus } from 'app/entities/menu/menu.reducer';
...
export class CategoryUpdate extends React.Component<ICategoryUpdateProps, ICategoryUpdateState> {
  ...
  render() {
    const { categoryEntity, menus, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="emenuApp.category.home.createOrEditLabel">
              <Translate contentKey="emenuApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : categoryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="descriptionLabel" for="description">
                    <Translate contentKey="emenuApp.category.description">Description</Translate>
                  </Label>
                ...
                <AvGroup>
                  ...
                  <AvInput id="category-menu" type="select" className="form-control" name="menuId">
                    <option value="" key="0" />
                    {menus
