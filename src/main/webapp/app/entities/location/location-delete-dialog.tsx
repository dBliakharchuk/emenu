...
import { getLocationEntity, deleteEntity } from './location.reducer';
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="emenuApp.location.delete.question">
          <Translate contentKey="emenuApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
...
const mapDispatchToProps = { getEntity: getLocationEntity, deleteEntity };
