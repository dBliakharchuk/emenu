...
export const EntitiesMenu = props => (
  ...
  <NavDropdown icon="th-list" name="Entities" id="entity-menu">
    {/*<DropdownItem tag={Link} to="/entity/authority-sql">
      <FontAwesomeIcon icon="asterisk" fixedWidth />&nbsp;<Translate contentKey="global.menu.entities.authoritySql" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/restaurant">
      <FontAwesomeIcon icon="asterisk" fixedWidth />&nbsp;<Translate contentKey="global.menu.entities.restaurant" />
    </DropdownItem>
    ...
    <DropdownItem tag={Link} to="/entity/photo">
      <FontAwesomeIcon icon="asterisk" fixedWidth />&nbsp;<Translate contentKey="global.menu.entities.photo" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/menu">
      <FontAwesomeIcon icon="asterisk" fixedWidth />&nbsp;<Translate contentKey="global.menu.entities.menu" />
    </DropdownItem>
    ...
    <DropdownItem tag={Link} to="/entity/dish">
      <FontAwesomeIcon icon="asterisk" fixedWidth />&nbsp;<Translate contentKey="global.menu.entities.dish" />
    </DropdownItem>*/}
