...
class RestaurantComponentUnlogged extends React.Component<IRestaurantComponentProps, IRestaurantComponentState> {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    ...
    return (
      <NavItem className="row col-xs-12 col-sm-6 col-md-4 col-lg-3" tag={Link} to={`/chosenRestaurantUnlogged/${id}`}>
