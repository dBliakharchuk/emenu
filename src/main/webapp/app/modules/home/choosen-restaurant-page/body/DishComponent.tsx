...
export interface IDishComponentPropsFull
  extends StateProps,
    IDishComponentPropsAddtional,
    DispatchProps,
...
class DishComponent extends React.Component<IDishComponentPropsFull, IDishComponentState> {
  ...
  constructor(props) {
    ...
    this.getPopUpWindow = this.getPopUpWindow.bind(this);
  }
  ...
  getPopUpWindow() {
    const { id, image, name, imageContentType } = this.props.dishEnt;
            ...
            <div className="modal row">
              ...
              <div className="content col-12">
                ...
                <div className="dish-popup-gallery col-lg-4 col-md-4 col-sm-12 col-xs-12">
                  <img className="col-lg-12 col-md-12 col-sm-12 col-xs-12" src={`data:${imageContentType};base64,${image}`} alt={name} />
                  {dishGallery.length > 0 && <Gallery margin={0} photos={dishGallery ? dishGallery : []} onClick={this.openLightbox} />}
              ...
              <div className="actions ol-lg-12 col-md-12 col-sm-12 col-xs-12">
                <Popup
                  trigger={<button className="popup-button"> Ingredients </button>}
                  position="top center"
  ...
  render() {
    const { id, name, price, imageContentType, image } = this.props.dishEnt;
    let url: string;
    let urlReplacementImg = 'https://www.zumoqr.com/assets/uploads/modeller/URL_Random_US.jpg';

    return (
      <GridListTile onClick={this.getPopUpWindow} key={id} className="main-body-dish-list-img col-lg-3 col-md-4 col-sm-4 col-xs-6">
        ...
        <GridListTileBar
          ...
          actionIcon={this.getPopUpWindow()}
        />
      </GridListTile>
    );
  }
